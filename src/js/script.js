...
// Public key
// let PUBLIC_KEY = "d526a6eaaa7325b2ccfb07858ff6cc93";

// private key
// let PRIVATE_KEY = "3cf7a38c9fa273c77cb4bd636ec8504779666e09";
...
// hash
// let hash = 13cf7a38c9fa273c77cb4bd636ec8504779666e09d526a6eaaa7325b2ccfb07858ff6cc93
// var MD5 hash = 1edd9f6ddc6b9da6f6cf877ab23457f3
...
async function searchHeros(textSearched) {
   ...
   await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&ts=1&apikey=d526a6eaaa7325b2ccfb07858ff6cc93&hash=1edd9f6ddc6b9da6f6cf877ab23457f3`)
         ...
         if (count <= 5) {
              ...
              <li class="flex-row single-search-result">
                   <div class="flex-row img-info">
                        ...
                        <div class="hero-info">
                             <a class="character-info" href="./heros.html">
                                  <span class="hero-name">${hero.name}</span>
                             </a>
                        </div>
                   </div>
                   <div class="flex-col buttons">
                        <!-- <button class="btn"><i class="fa-solid fa-circle-info"></i> &nbsp; heros Info</button> -->
